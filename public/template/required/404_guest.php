...
<body>
	<header class="banner">
		<h1><a href="<?php print($this->functions->html_escape($config['URL'])); ?>"><span class="logo-100 title"></span></a><?php print($this->functions->html_escape($config['WEBSITE_TITLE'])); ?></h1>
	</header>

	<nav>
		<ul>
			<li class="pull-left"><a href="<?php print($this->functions->html_escape($config['URL'])); ?>">Home</a></li>
			<li class="pull-right p-b-20 p-r-20"><a href="<?php print($this->functions->html_escape($config['URL'])); ?>register.php">Register an account</a></li>
		</ul>
	</nav>
